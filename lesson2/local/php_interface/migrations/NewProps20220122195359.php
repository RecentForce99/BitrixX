...
class NewProps20220122195359 extends Version
{
    /** @var string $description */
    protected $description = "Добавим новые свойства для ИБ Карты";
    ...
    public function down()
    {
        ...
        $helper->Iblock()->deletePropertyIfExists($iblockId, 'VALIDITY_TIME');
